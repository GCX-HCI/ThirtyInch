...
public class TiPresenterDestroyTest {
    ...
    public void saviorFalse_dontKeepActivitiesTrue_configurationChange() throws Exception {
        ...
        final TiActivityDelegate<TestPresenter, TiView> delegate = new Delegate(presenter, false, true, true, new TiPresenterProvider<TestPresenter>() {
            @NonNull
            @Override
    ...
    @Test
    public void saviorFalse_dontKeepActivitiesTrue_moveToBackground_moveToForeground() throws Exception {
        final TestPresenter presenter = new TestPresenter(new TiConfiguration.Builder()
                .setUseStaticSaviorToRetain(false)
                .build());

        final TiActivityDelegate<TestPresenter, TiView> delegate = new Delegate(presenter, false, false, true, new TiPresenterProvider<TestPresenter>() {
            @NonNull
            @Override
            public TestPresenter providePresenter() {
                return null;
        ...
        assertThat(delegate.getPresenter().isCreated()).isTrue();

        delegate.onStart_beforeSuper();
    ...
    public void saviorFalse_dontKeepActivitiesFalse_configurationChange() throws Exception {
        ...
        final TiActivityDelegate<TestPresenter, TiView> delegate = new Delegate(presenter, false, true, false, new TiPresenterProvider<TestPresenter>() {
            @NonNull
            @Override
            public TestPresenter providePresenter() {
                return null;
    ...
    @Test
    public void saviorFalse_dontKeepActivitiesFalse_moveToBackground_moveToForeground() throws Exception {
        final TestPresenter presenter = new TestPresenter(new TiConfiguration.Builder()
                .setUseStaticSaviorToRetain(false)
                .build());

        final TiActivityDelegate<TestPresenter, TiView> delegate = new Delegate(presenter, false, false, false, new TiPresenterProvider<TestPresenter>() {
            @NonNull
            @Override
            public TestPresenter providePresenter() {
                return null;
    ...
    @Test
    public void saviorTrue_dontKeepActivitiesTrue_moveToBackground_moveToForeground() throws Exception {
        final TestPresenter presenter = new TestPresenter(new TiConfiguration.Builder()
                .setUseStaticSaviorToRetain(true)
                .build());
    ...
    @Test
    public void saviorTrue_dontKeepActivitiesFalse_moveToBackground_moveToForeground() throws Exception {
        final TestPresenter presenter = new TestPresenter(new TiConfiguration.Builder()
                .setUseStaticSaviorToRetain(true)
                .build());
